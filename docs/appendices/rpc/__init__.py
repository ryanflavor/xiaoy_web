...
NOT_ALIVE_TOPIC: str = "_not_alive"
...
def kill_port_process(port: int, kill_parent_cmd: bool):
    import psutil
    ...
    for connection in all_connections:
        if connection.laddr.port == port:
            ...
            print("尝试杀死占用端口的进程...")
            process.terminate()
            if kill_parent_cmd and parent_process.name() == "cmd.exe":
                print("尝试杀死父进程cmd.exe ...")
